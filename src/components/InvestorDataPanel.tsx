...
export function InvestorDataPanel() {
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="border rounded-lg overflow-hidden max-h-64 overflow-y-auto">
                          <Table>
                            ...
                            <TableBody>
                              {investorContactPreview.data.slice(0, 10).map((contact, i) => {
                                const isDuplicate = investorContactPreview.duplicates.some(
                                  d => d.existingId === contact.investor_id
                                );
                                return (
                                  <TableRow key={i}>
                                    <TableCell className="font-mono text-xs">
                                      {contact.investor_id?.slice(0, 8)}...
                                    </TableCell>
                              ...
                              {investorContactPreview.data.length > 10 && (
                                <TableRow>
                                  <TableCell colSpan={5} className="text-center text-muted-foreground">
                                    ... 還有 {investorContactPreview.data.length - 10} 筆資料
                                  </TableCell>
                                </TableRow>
                              )}
                            </TableBody>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="border rounded-lg overflow-hidden max-h-64 overflow-y-auto">
                          <Table>
                            ...
                            <TableBody>
                              {investorPaymentMethodPreview.data.slice(0, 10).map((payment, i) => {
                                const isDuplicate = investorPaymentMethodPreview.duplicates.some(
                                  d => d.existingId === payment.investor_id
                                );
                                return (
                                  <TableRow key={i}>
                                    <TableCell className="font-mono text-xs">
                                      {payment.investor_id?.slice(0, 8)}...
                                    </TableCell>
                              ...
                              {investorPaymentMethodPreview.data.length > 10 && (
                                <TableRow>
                                  <TableCell colSpan={5} className="text-center text-muted-foreground">
                                    ... 還有 {investorPaymentMethodPreview.data.length - 10} 筆資料
                                  </TableCell>
                                </TableRow>
                              )}
                            </TableBody>
