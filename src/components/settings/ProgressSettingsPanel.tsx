    ...
    <div className="space-y-6">
                  ...
                  {currentMilestones.length === 0 ? (
                    ...
                    currentMilestones.map((milestone, index) => (
                      <TableRow key={milestone.id} className={!milestone.is_active ? 'opacity-50' : ''}>
                        ...
                        <TableCell>
                          <Switch
                            checked={editingId === milestone.id ? editForm.is_required : milestone.is_required}
                            onCheckedChange={(checked) => {
                              if (editingId === milestone.id) {
                                setEditForm({ ...editForm, is_required: checked });
                              }
                            }}
                            disabled={editingId !== milestone.id}
                          />
                        </TableCell>
                        <TableCell>
                          <Switch
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>設定里程碑完成時的通知規則</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>新增{activeTab === 'admin' ? '行政' : '工程'}里程碑</DialogTitle>
            <DialogDescription>
              建立新的里程碑項目
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                <Switch
                  checked={newMilestone.is_required}
          ...
          <DialogFooter>
            ...
            <Button onClick={handleAddMilestone}>新增</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
